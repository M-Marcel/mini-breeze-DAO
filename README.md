...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/M-Marcel/mini-breeze-DAO)
...
1. Clone this repo:
```
git clone https://github.com/M-Marcel/mini-breeze-DAO
cd mini-breeze-DAO
```
...
See the [open issues](https://github.com/M-Marcel/mini-breeze-DAO/issues) for a full list of proposed features (and known issues).
...
Marcellus Nwankwo - [@Marcel_di_Maria](https://twitter.com/Marcel_di_Maria)
